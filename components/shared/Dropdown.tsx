  ...
  return (
    <Select onValueChange={onChangeHandler} defaultValue={value} >
        ...
        <SelectContent>
           ...
           <AlertDialog>
                <AlertDialogTrigger className="p-medium-14 w-full rounded-sm py-3 pl-8 text-primary-500 hover:bg-indigo-50 focus:text-primary-500">Open</AlertDialogTrigger>
