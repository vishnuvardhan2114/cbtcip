              ...
              <FormItem className="w-full ">
                <FormControl className="h-72">
                  <Textarea
                    ...
                    {...field}
                    className="bg-gray-50 flex flex-1 placeholder:text-grey-500 p-regular-16 px-5 py-3 border-none focus-visible:ring-transparent !important rounded-2xl "
                  />
                </FormControl>
                <FormMessage />
              </FormItem>
                          ...
                          <FormControl>
                            <div className="flex items-center">
                              ...
                              <Checkbox
                                ...
                                checked={field.value}
                                id="isFree"
                                className="mr-2 h-5 w-5 border-2 border-purple-100 "
                              />
                            </div>
                          </FormControl>
                          <FormMessage />
